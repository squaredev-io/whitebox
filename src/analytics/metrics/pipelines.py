...
def create_feature_metrics_pipeline(dataset:pd.DataFrame)->Dict[str,Union[int,float]]:
...
def create_binary_classification_evaluation_metrics_pipeline(test_set:pd.DataFrame,prediction_set:pd.DataFrame)->Dict[str,Union[int,float]]:
...
def create_multiple_classification_evaluation_metrics_pipeline(test_set:pd.DataFrame,prediction_set:pd.DataFrame)->Dict[str,Union[float,Dict[str,Union[int,float]]]]:
    accuracy=metrics.accuracy_score(test_set,prediction_set)
