...
def create_xai_pipeline_classification_per_inference_row(training_set: pd.DataFrame, target: str, inference_row: pd.DataFrame, type_of_task: str, load_from_path = None
)-> Dict[str, float]:
    ...
    if type_of_task=='multiclass_classification':
        ...
        explainability_report = {mapping_dict[name]: val for name, val in temp_dict.items()}
