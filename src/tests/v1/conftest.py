...
test_order_map = {
    ...
    "dataset_rows": {"create": 13, "get_model's_all": 14, "create_model_doesn't_exist": 27},
    "inference_rows": {"create": 16, "create_many": 17, "get_model's_all": 18, "get": 19},
    
    # Cron jobs run so metrics are calclulated
    "cron_tasks": {"run": 20},

    # User requests metrics
    "performance_metrics": {"get_model's_all": 21},
    "drifting_metrics": {"get_model's_all": 22, "get": 23},
    "model_integrity_metrics": {"get_model's_all": 24, "get": 25},
}
